            ...
            <div class="col-9 content">
                <div class="container d-flex justify-content-between">
                    ...
                    <form method="GET" action="{{ route('layouts.analytics') }}" class="w-40 d-flex">
                        ...
                        <button class="btn select w-50" type="submit"
                    ...
                    <div class="row w-100">
                        <div class="col-8">
                            <div class="chart me-3">
                                ...
                                @include('analytics.passengers_per_day', [
                                    'passengersPerPeriod' => $passengersPerPeriod,
                                ])
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="chart lineChartContainer">
                                ...
                                @include('analytics.frequent_pickup_point', [
                                    'frequentPickupPoints' => $frequentPickupPoints,
                                ])
                            </div>
                        </div>
                    </div>
