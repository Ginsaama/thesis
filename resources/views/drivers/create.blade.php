                ...
                <div class="col-8 content-create">
                    ...
                    <div class="driver-info container d-flex align-items-center mt-5 mb-5">
                        ...
                        <div class="infos">
                            ...
                            <div class="info mt-5">
                                ...
                                <input type="tel" name="contact_number" id="" placeholder="Contact Number"
                                    value="">
                                <input type="text" name="license_number" id="" placeholder="License Number"
                                    value="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="infos container mt-4">
                        <div class="info m-0">
                            ...
                            <input type="text" name="plate_number" id="" placeholder="Plate Number"
                                value="">
                        </div>
                        <!-- <div class="info mt-5">
