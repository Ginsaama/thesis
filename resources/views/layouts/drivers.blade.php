                                ...
                                <tr>
                                    ...
                                    <td id="btn-action">
                                        ...
                                        <form method="POST" class="btn-delete"
                                            action="{{ route('drivers.delete', $driver->driver_id) }}">
                                            @csrf
                                            @method('DELETE')
                                            ...
                                            <a href="#"
                                                onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this driver?')) { this.closest('form').submit(); }">
                                                <img src="{{ asset('images/delete-icon.png') }}" title="Delete">
                                            </a>
                                        </form>
                                    </td>
